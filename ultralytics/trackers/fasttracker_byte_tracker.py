...
# FastTracker compatibility base vendored from official ultralytics v8.4.105
# (a7e7e65a3e4086c5d2104dca06f6593564eda1ae). It is kept separate from byte_tracker.py
# to avoid changing the behavior of this checkout's pre-existing ByteTrack and BoT-SORT implementations.
