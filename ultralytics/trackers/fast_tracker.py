...
# Vendored from official ultralytics v8.4.105 (a7e7e65a3e4086c5d2104dca06f6593564eda1ae).
# The base import is intentionally isolated so the repository's existing ByteTrack remains unchanged.
...
from .fasttracker_byte_tracker import BYTETracker, STrack
