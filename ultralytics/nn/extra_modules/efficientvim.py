...
__all__ = ["EfficientViMBlock", "EfficientViMBlock_CGLU"]
...
class EfficientViMBlock_CGLU(EfficientViMBlock):
    def __init__(self, dim, mlp_ratio=4, ssd_expand=1, state_dim=64):
        super().__init__(dim, mlp_ratio, ssd_expand, state_dim)

        self.ffn = ConvolutionalGLU(dim, hidden_features=int(dim * mlp_ratio))
