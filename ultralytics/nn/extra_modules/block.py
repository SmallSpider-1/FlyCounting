...
from timm.layers import CondConv2d, to_2tuple, trunc_normal_, use_fused_attn
...
from ..backbone.lsnet import Block as LSBlock
from ..backbone.lsnet import LSConv
...
from .CSI import CSI
from .CSSC import CNCM, CSSC
from .DarkIR import DBlock, EBlock
from .DCMPNet import *
from .deconv import DEConv
from .dsan import *
from .dynamic_snake_conv import DySnakeConv
from .efficientvim import *
from .esc import ConvAttn, ESCBlock
from .EVA import EVA
from .EVSSM import EDFFN, EVS
from .fadc import AdaptiveDilatedConv
from .FDConv_initialversion import FDConv
from .filc import *
from .gcconv import GCConv
from .GroupMamba.groupmamba import Block_mamba, GroupMambaLayer
from .hcfnet import PPA, LocalGlobalAttention
from .HFRB import HFRB
from .kan_convs import FastKANConv2DLayer, KACNConv2DLayer, KAGNConv2DLayer, KALNConv2DLayer, KANConv2DLayer
...
from .orepa import *
from .PlainUSR import LocalAttention, RepMBConv
...
from .transMamba import SpectralEnhancedFFN, TransMambaBlock
...
class DyDCNv2(nn.Module):
    """ModulatedDeformConv2d with normalization layer used in DyHead. This module cannot be configured with
    `conv_cfg=dict(type='DCNv2')` because DyHead calculates offset and mask from middle-level feature.
...
class C3k2_KW(C3k2):
    def __init__(self, c1, c2, n=1, wm=None, wm_name=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_KW(self.c, self.c, 2, wm, wm_name, shortcut, g) if c3k else Bottleneck_KW(self.c, self.c, wm, wm_name)
            for _ in range(n)
        )
...
class C3k2_DySnakeConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DySnakeConv(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_DySnakeConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_DCNv2(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DCNv2(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_DCNV2(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_DCNv3(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DCNv3(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_DCNV3(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_OREPA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_OREPA(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_OREPA(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_REPVGGOREPA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_REPVGGOREPA(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_REPVGGOREPA(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_DCNv2_Dynamic(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DCNv2_Dynamic(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_DCNV2_Dynamic(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_MSBlock(C3k2):
    def __init__(
        ...
        self.m = nn.ModuleList(
            ...
            if c3k
            else MSBlock(self.c, self.c, kernel_sizes, in_expand_ratio, mid_expand_ratio, layers_num, in_down_ratio)
            for _ in range(n)
        )
...
class C3k2_EMBC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_EMBC(self.c, self.c, 2, shortcut, g) if c3k else MBConv(self.c, self.c, shortcut) for _ in range(n)
        )
...
class C3k_DAttention(C3k):
    def __init__(self, c1, c2, n=1, fmapsize=None, shortcut=False, g=1, e=0.5, k=3):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(
            *(Bottleneck_DAttention(c_, c_, fmapsize, shortcut, g, k=(k, k), e=1.0) for _ in range(n))
        )
...
class C3k2_DAttention(C3k2):
    def __init__(self, c1, c2, n=1, fmapsize=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DAttention(self.c, self.c, 2, fmapsize, shortcut, g)
            if c3k
...
class C3k2_Parc(C3k2):
    def __init__(self, c1, c2, n=1, fmapsize=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_Parc(self.c, self.c, 2, fmapsize, shortcut, g)
            if c3k
...
class C3k2_RFCBAMConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_RFCBAMConv(self.c, self.c, 2, shortcut, g)
            if c3k
...
class C3k2_DRB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DRB(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_DRB(self.c, self.c, shortcut, g, k=(3, 3), e=1.0)
            for _ in range(n)
        )
...
class C3k_AggregatedAtt(C3k):
    def __init__(self, c1, c2, n=1, input_resolution=None, sr_ratio=None, shortcut=False, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(
            *(
                Bottleneck_AggregatedAttention(c_, c_, input_resolution, sr_ratio, shortcut, g, k=(k, k), e=1.0)
                for _ in range(n)
            )
        )
...
class C3k2_AggregatedAtt(C3k2):
    def __init__(self, c1, c2, n=1, input_resolution=None, sr_ratio=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_AggregatedAtt(self.c, self.c, 2, input_resolution, sr_ratio, shortcut, g)
            if c3k
...
class C3k2_DCNv4(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DCNv4(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_DCNV4(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class ELA_HSFPN(nn.Module):
    def __init__(self, in_planes, flag=True):
        ...
        self.conv1x1 = nn.Sequential(
            nn.Conv1d(in_planes, in_planes, 7, padding=3), nn.GroupNorm(16, in_planes), nn.Sigmoid()
        )
        self.flag = flag
...
class C3k2_iRMB_Cascaded(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_iRMB_Cascaded(self.c, self.c, 2, shortcut, g) if c3k else iRMB_Cascaded(self.c, self.c)
            for _ in range(n)
        )
...
class C3k2_iRMB_DRB(C3k2):
    def __init__(self, c1, c2, n=1, kernel_size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_iRMB_DRB(self.c, self.c, 2, kernel_size, shortcut, g)
            if c3k
...
class C3k2_iRMB_SWC(C3k2):
    def __init__(self, c1, c2, n=1, kernel_size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_iRMB_SWC(self.c, self.c, 2, kernel_size, shortcut, g)
            if c3k
...
class C3k2_VSS(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_VSS(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_VSS(self.c, self.c, shortcut, g, k=(3, 3), e=1.0)
            for _ in range(n)
        )
...
class C3k2_DynamicConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DynamicConv(self.c, self.c, 2, shortcut, g)
            if c3k
...
class C3k2_GhostDynamicConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_GhostDynamicConv(self.c, self.c, 2, shortcut, g) if c3k else GhostModule(self.c, self.c)
            for _ in range(n)
        )
...
class C3k2_RetBlock(C3k2):
    def __init__(self, c1, c2, n=1, retention="chunk", num_heads=8, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k_RetBlock(self.c, self.c, 2, retention, num_heads, shortcut, g)
            if c3k
...
class C3k2_PKIModule(C3k2):
    def __init__(
        ...
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_PKIModule(self.c, self.c, 2, kernel_sizes, expansion, with_caa, caa_kernel_size, add_identity)
            if c3k
...
class C3k2_FADC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FADC(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_FADC(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_PPA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_PPA(self.c, self.c, 2, shortcut, g) if c3k else PPA(self.c, self.c) for _ in range(n)
        )
...
class C3k2_Faster_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_Faster_CGLU(self.c, self.c, 2, shortcut, g) if c3k else Faster_Block_CGLU(self.c, self.c)
            for _ in range(n)
        )
...
class GEFM(nn.Module):
    ...
    def forward(self, x, y):
        ...
        RGB_K = self.RGB_K(x)
        RGB_V = self.RGB_V(x)
        m_batchsize, _C, height, width = RGB_V.size()
...
class C3k2_KAN(C3k2):
    def __init__(self, c1, c2, n=1, kan_mothed=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_KAN(self.c, self.c, 2, kan_mothed, shortcut, g)
            if c3k
            else Bottleneck_KAN(self.c, self.c, kan_mothed, shortcut, g)
            for _ in range(n)
        )
...
class EIEStem(nn.Module):
    def __init__(self, inc, hidc, ouc) -> None:
        ...
        self.pool_branch = nn.Sequential(
            nn.ZeroPad2d((0, 1, 0, 1)), nn.MaxPool2d(kernel_size=2, stride=1, padding=0, ceil_mode=True)
        )
...
class C3k2_DEConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DEConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_DEConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class SMPCGLU(nn.Module):
    def __init__(self, inc, kernel_size, drop_path=0.1, n_points=4):
        super().__init__()
        self.drop_path = DropPath(drop_path) if drop_path > 0.0 else nn.Identity()
        self.mlp = ConvolutionalGLU(inc)
        self.smpconv = nn.Sequential(
            SMPConv(inc, kernel_size, n_points, 1, padding=kernel_size // 2, groups=1), Conv.default_act
        )
...
class C3k2_SMPCGLU(C3k2):
    def __init__(self, c1, c2, n=1, kernel_size=13, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SMPCGLU(self.c, self.c, 2, kernel_size, shortcut, g) if c3k else SMPCGLU(self.c, kernel_size)
            for _ in range(n)
        )
...
class C3k2_Heat(C3k2):
    def __init__(self, c1, c2, n=1, feat_size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_Heat(self.c, self.c, 2, feat_size, shortcut, g) if c3k else HeatBlock(self.c, feat_size)
            for _ in range(n)
        )
...
class SBA(nn.Module):
    ...
    def forward(self, x):
        ...
        L_feature = (
            ...
            + (1 - g_L_feature) * Upsample(g_H_feature * H_feature, size=L_feature.size()[2:], align_corners=False)
        )
        H_feature = (
            H_feature
            + H_feature * g_H_feature
            + (1 - g_H_feature) * Upsample(g_L_feature * L_feature, size=H_feature.size()[2:], align_corners=False)
        )
...
class WaveletPool(nn.Module):
    def __init__(self):
        ...
        filts = np.stack(
            [ll[None, ::-1, ::-1], lh[None, ::-1, ::-1], hl[None, ::-1, ::-1], hh[None, ::-1, ::-1]], axis=0
        )
...
class C3k2_WTConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_WTConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_WTConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class RCM(nn.Module):
    ...
    def __init__(
        ...
        self.token_mixer = token_mixer(
            dim, band_kernel_size=dw_size, square_kernel_size=square_kernel_size, ratio=ratio
        )
...
class C3k2_gConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_gConv(self.c, self.c, 2, shortcut, n) if c3k else gConvBlock(self.c) for _ in range(n)
        )
...
class AdditiveBlock(nn.Module):
    ...
    def __init__(
        self, dim, mlp_ratio=4.0, attn_bias=False, drop=0.0, drop_path=0.0, act_layer=nn.GELU, norm_layer=nn.BatchNorm2d
    ):
        super().__init__()
...
class AdditiveBlock_CGLU(AdditiveBlock):
    def __init__(
        self, dim, mlp_ratio=4, attn_bias=False, drop=0, drop_path=0, act_layer=nn.GELU, norm_layer=nn.BatchNorm2d
    ):
...
class C3k2_AdditiveBlock_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_AdditiveBlock_CGLU(self.c, self.c, 2, shortcut, g) if c3k else AdditiveBlock_CGLU(self.c)
            for _ in range(n)
        )
...
class Mutilscal_MHSA(nn.Module):
    ...
    def forward(self, x):
        ...
        attn = rearrange(
            attn, "(b) h (hh ww) d -> b (h d) (hh) (ww)", h=self.num_heads, d=C // self.num_heads, hh=H, ww=W
        )
...
class C3k2_MSMHSA_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MSMHSA_CGLU(self.c, self.c, 2, shortcut, g) if c3k else MSMHSA_CGLU(self.c) for _ in range(n)
        )
...
class C3k2_MogaBlock(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MogaBlock(self.c, self.c, 2, shortcut, g) if c3k else MogaBlock(self.c) for _ in range(n)
        )
...
class C3k2_SHSA_EPGO(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SHSA_EPGO(self.c, self.c, 2, shortcut, g) if c3k else SHSABlock_EPGO(self.c) for _ in range(n)
        )
...
class C3k2_SHSA_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SHSA_CGLU(self.c, self.c, 2, shortcut, g) if c3k else SHSABlock_CGLU(self.c) for _ in range(n)
        )
...
class C3k2_SHSA_EPGO_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SHSA_EPGO_CGLU(self.c, self.c, 2, shortcut, g) if c3k else SHSABlock_EPGO_CGLU(self.c) for _ in range(n)
        )
...
class C3k2_SMAFB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SMAFB(self.c, self.c, 2, shortcut, g) if c3k else SMAFormerBlock(self.c) for _ in range(n)
        )
...
class C3k2_SMAFB_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SMAFB_CGLU(self.c, self.c, 2, shortcut, g) if c3k else SMAFormerBlock_CGLU(self.c) for _ in range(n)
        )
...
class C3k2_IdentityFormer(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_IdentityFormer(self.c, self.c, n, shortcut, g)
            if c3k
            else MetaFormerBlock(
                dim=self.c,
                token_mixer=nn.Identity,
                norm_layer=partial(LayerNormGeneral, normalized_dim=(1, 2, 3), eps=1e-6, bias=False),
            )
    ...
    def __init__(self, c1, c2, n=1, num_tokens=196, shortcut=False, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(
            *(
                MetaFormerBlock(
                    dim=c_,
                    token_mixer=partial(RandomMixing, num_tokens=num_tokens),
                    norm_layer=partial(LayerNormGeneral, normalized_dim=(1, 2, 3), eps=1e-6, bias=False),
                )
                for _ in range(n)
            )
...
class C3k2_RandomMixing(C3k2):
    def __init__(self, c1, c2, n=1, num_tokens=196, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_RandomMixing(self.c, self.c, n, num_tokens, shortcut, g)
            if c3k
            else MetaFormerBlock(
                dim=self.c,
                token_mixer=partial(RandomMixing, num_tokens=num_tokens),
...
class C3k2_PoolingFormer(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_PoolingFormer(self.c, self.c, n, shortcut, g)
            if c3k
            else MetaFormerBlock(
                dim=self.c,
                token_mixer=Pooling,
...
class C3k_ConvFormer(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(MetaFormerBlock(dim=c_, token_mixer=SepConv) for _ in range(n)))
...
class C3k2_ConvFormer(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_ConvFormer(self.c, self.c, n, shortcut, g) if c3k else MetaFormerBlock(dim=self.c, token_mixer=SepConv)
            for _ in range(n)
        )
...
class C3k_CaFormer(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(MetaFormerBlock(dim=c_, token_mixer=MF_Attention) for _ in range(n)))
...
class C3k2_CaFormer(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_CaFormer(self.c, self.c, n, shortcut, g)
            if c3k
            else MetaFormerBlock(dim=self.c, token_mixer=MF_Attention)
            for _ in range(n)
        )
...
class C3k2_IdentityFormerCGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_IdentityFormerCGLU(self.c, self.c, n, shortcut, g)
            if c3k
...
class C3k2_RandomMixingCGLU(C3k2):
    def __init__(self, c1, c2, n=1, num_tokens=196, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_RandomMixingCGLU(self.c, self.c, n, num_tokens, shortcut, g)
            if c3k
            else MetaFormerCGLUBlock(
                dim=self.c,
                token_mixer=partial(RandomMixing, num_tokens=num_tokens),
...
class C3k2_PoolingFormerCGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_PoolingFormerCGLU(self.c, self.c, n, shortcut, g)
            if c3k
            else MetaFormerCGLUBlock(
                dim=self.c,
                token_mixer=Pooling,
...
class C3k_ConvFormerCGLU(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(MetaFormerCGLUBlock(dim=c_, token_mixer=SepConv) for _ in range(n)))
...
class C3k_CaFormerCGLU(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(MetaFormerCGLUBlock(dim=c_, token_mixer=MF_Attention) for _ in range(n)))
...
class C3k2_CaFormerCGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_CaFormerCGLU(self.c, self.c, n, shortcut, g)
            if c3k
            else MetaFormerCGLUBlock(dim=self.c, token_mixer=MF_Attention)
            for _ in range(n)
        )
...
class C3k2_MutilScaleEdgeInformationSelect(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MutilScaleEdgeInformationSelect(self.c, self.c, 2, shortcut, g)
            if c3k
...
class SFHF_FourierUnit(nn.Module):
    def __init__(self, in_channels, out_channels, groups=4):
        ...
        self.fpe = nn.Conv2d(
            in_channels * 2, in_channels * 2, kernel_size=3, padding=1, stride=1, groups=in_channels * 2, bias=True
        )
...
class SFHF_Mixer(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.dim = dim
        self.mixer_local = token_mixer_for_local(
            dim=self.dim,
        )
        self.mixer_gloal = token_mixer_for_gloal(
            dim=self.dim,
...
class C3k2_SFHF(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SFHF(self.c, self.c, 2, shortcut, g) if c3k else SFHF_Block(self.c) for _ in range(n)
        )
    ...
    def forward(self, x):
        ...
        for i in range(len(self.pools_sizes)):
            ...
            if i != len(self.pools_sizes) - 1:
                F.interpolate(y, scale_factor=2, mode="bilinear", align_corners=True)
        resl = self.relu(resl)
...
class dynamic_filter(nn.Module):
    ...
    def forward(self, x):
        ...
        n, c, h, w = x.shape
        x = F.unfold(self.pad(x), kernel_size=self.kernel_size, dilation=self.dilation).reshape(
...
class spatial_strip_att(nn.Module):
    ...
    def forward(self, x):
        ...
        n, c, h, w = x.shape
        x = F.unfold(self.pad(x), kernel_size=self.kernel, dilation=self.dilation).reshape(
            n, self.group, c // self.group, self.k, h * w
        )
...
class C3k2_MSM(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MSM(self.c, self.c, 2, shortcut, g) if c3k else DeepPoolLayer(self.c) for _ in range(n)
        )
...
class C3k2_HDRAB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_HDRAB(self.c, self.c, 2, shortcut, g) if c3k else HDRAB(self.c, self.c) for _ in range(n)
        )
...
class C3k2_RAB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_RAB(self.c, self.c, 2, shortcut, g) if c3k else RAB(self.c, self.c) for _ in range(n)
        )
...
class C3k2_LFE(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_LFE(self.c, self.c, 2, shortcut, g) if c3k else LFE(self.c, self.c) for _ in range(n)
        )
...
class FCA_SFA(nn.Module):
    ...
    def forward(self, x):
        """Input: x: (B, H*W, C), x_size: (H, W) Output: x: (B, H*W, C).
        """
        b, n, H, W = x.size()
...
class C3k2_FCA_SFA(C3k2):
    def __init__(self, c1, c2, n=1, reso=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FCA_SFA(self.c, self.c, 2, reso, shortcut, g) if c3k else FCA_SFA(self.c, reso=reso) for _ in range(n)
        )
...
class C3k2_FCA_CTA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FCA_CTA(self.c, self.c, 2, shortcut, g) if c3k else FCA_CTA(self.c) for _ in range(n)
        )
...
class C3k2_IDWC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_IDWC(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_IDWC(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_IDWB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_IDWB(self.c, self.c, 2, shortcut, g) if c3k else MetaNeXtBlock(self.c) for _ in range(n)
        )
...
class C3k2_CAMixer(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_CAMixer(self.c, self.c, 2, shortcut, g) if c3k else CAMixer(self.c, window_size=4) for _ in range(n)
        )
...
class MessageAgg(nn.Module):
    ...
    def forward(self, X, path):
        """X: [n_node, dim] path: col(source) -> row(target).
        """
...
class RSA(nn.Module):
    ...
    def forward(self, x, prev_atns=None):
        ...
        if prev_atns is None:
            ...
            out = v @ attn
            out = rearrange(
                out, "b (h w) (dh dw) c-> b (c) (h dh) (w dw)", h=h // wsize, w=w // wsize, dh=wsize, dw=wsize
            )
            if self.shifts > 0:
    ...
    def __init__(self, inp_channels, num_heads=4, window_sizes=4, shifts=0, shared_depth=1, ffn_expansion_factor=2.66):
        ...
        for i in range(shared_depth):
            ...
            modules_att[f"att_{i}"] = RSA(
                channels=inp_channels, num_heads=num_heads, shifts=shifts, window_sizes=window_sizes
            )
...
class Faster_Block_KAN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = shortcut + self.drop_path(
            self.mlp(x.flatten(2).permute(0, 2, 1)).permute(0, 2, 1).view([-1, C, H, W]).contiguous()
        )
        return x
...
class C3k2_Faster_KAN(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_Faster_KAN(self.c, self.c, 2, shortcut, g) if c3k else Faster_Block_KAN(self.c, self.c)
            for _ in range(n)
        )
...
class C3k2_ELGCA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_ELGCA(self.c, self.c, 2, shortcut, g) if c3k else ELGCA_EncoderBlock(self.c) for _ in range(n)
        )
...
class C3k2_ELGCACGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_ELGCACGLU(self.c, self.c, 2, shortcut, g) if c3k else ELGCA_CGLU(self.c) for _ in range(n)
        )
...
class C3k2_Strip(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_Strip(self.c, self.c, 2, shortcut, g) if c3k else StripBlock(self.c) for _ in range(n)
        )
...
class C3k2_StripCGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_StripCGLU(self.c, self.c, 2, shortcut, g) if c3k else StripCGLU(self.c) for _ in range(n)
        )
...
class DynamicInceptionDWConv2d(nn.Module):
    ...
    def __init__(self, in_channels, square_kernel_size=3, band_kernel_size=11):
        ...
        self.dwconv = nn.ModuleList(
            [
                nn.Conv2d(
                    in_channels, in_channels, square_kernel_size, padding=square_kernel_size // 2, groups=in_channels
                ),
                nn.Conv2d(
                    in_channels,
                    in_channels,
        ...
        self.dkw = nn.Sequential(nn.AdaptiveAvgPool2d(1), nn.Conv2d(in_channels, in_channels * 3, 1))
...
class DynamicCIncMixerBlock_KAN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x + self.drop_path(
            ...
            * self.mlp(self.norm2(x).flatten(2).permute(0, 2, 1)).permute(0, 2, 1).view([-1, C, H, W]).contiguous()
        )
        return x
...
class C3k2_DCMB_KAN(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DCMB_KAN(self.c, self.c, 2, shortcut, g) if c3k else DynamicCIncMixerBlock_KAN(self.c) for _ in range(n)
        )
...
class GlobalFilterBlock(nn.Module):
    def __init__(self, dim, size, mlp_ratio=4.0, drop_path=0.0):
        super().__init__()
...
class C3k2_GlobalFilter(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_GlobalFilter(self.c, self.c, 2, size, shortcut, g) if c3k else GlobalFilterBlock(self.c, size)
            for _ in range(n)
        )
    ...
    def __init__(self, c1, c2, n=1, size=None, shortcut=False, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(
            *(
                MetaFormerBlock(
                    dim=c_,
                    token_mixer=partial(DynamicFilter, size=size),
                )
                for _ in range(n)
            )
        )
...
class C3k2_DynamicFilter(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DynamicFilter(self.c, self.c, n, size, shortcut, g)
            if c3k
            else MetaFormerBlock(
                dim=self.c,
                token_mixer=partial(DynamicFilter, size=size),
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(
            *(
                MetaFormerBlock(
                    dim=c_,
                    token_mixer=AttentionTSSA_Meta,
                )
                for _ in range(n)
            )
        )
...
class C3k2_TSSA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_TSSA(self.c, self.c, n, shortcut, g)
            if c3k
            else MetaFormerBlock(
                dim=self.c,
                token_mixer=AttentionTSSA_Meta,
...
class C3k2_SAVSS(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SAVSS(self.c, self.c, n, shortcut, g) if c3k else SAVSS_Layer(self.c) for _ in range(n)
        )
...
class C3k2_MobileMamba(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MobileMamba(self.c, self.c, n, shortcut, g) if c3k else MobileMambaBlock(self.c) for _ in range(n)
        )
...
class C3k2_MambaOut(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MambaOut(self.c, self.c, n, shortcut, g) if c3k else GatedCNNBlock_BCHW(self.c) for _ in range(n)
        )
...
class ABlock_DFFN_DYT(ABlock):
    ...
    def forward(self, x):
        ...
        return (
            x
            + self.mlp(self.dyt2(x).flatten(2).permute(0, 2, 1), H, W).permute(0, 2, 1).view([-1, C, H, W]).contiguous()
        )
...
class C3k2_MambaOut_UniRepLK(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MambaOut_UniRepLK(self.c, self.c, n, shortcut, g) if c3k else GatedUniRepLKBlock_BCHW(self.c)
            for _ in range(n)
        )
...
class C3k2_EfficientVIM(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_EfficientVIM(self.c, self.c, n, shortcut, g) if c3k else EfficientViMBlock(self.c) for _ in range(n)
        )
...
class C3k2_EfficientVIM_CGLU(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_EfficientVIM_CGLU(self.c, self.c, n, shortcut, g) if c3k else EfficientViMBlock_CGLU(self.c)
            for _ in range(n)
        )
...
class C3k2_RCB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_RCB(self.c, self.c, n, shortcut, g) if c3k else RepConvBlock(self.c) for _ in range(n)
        )
...
class C3k2_LSBlock(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_LSBlock(self.c, self.c, n, shortcut, g) if c3k else LSBlock(self.c, depth=1) for _ in range(n)
        )
...
class C3k2_MambaOut_LSConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MambaOut_LSConv(self.c, self.c, n, shortcut, g) if c3k else GatedLSBlock_BCHW(self.c) for _ in range(n)
        )
...
class C3k2_TransMamba(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_TransMamba(self.c, self.c, n, shortcut, g) if c3k else TransMambaBlock(self.c) for _ in range(n)
        )
...
class C3k2_FDConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FDConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_FDConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_MambaOut_FDConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MambaOut_FDConv(self.c, self.c, n, shortcut, g) if c3k else GatedFDConvBlock_BCHW(self.c)
            for _ in range(n)
        )
...
class FasterFDConv(nn.Module):
    def __init__(
        ...
        self.spatial_mixing = Partial_FDConv(dim, n_div, pconv_fw_type)
...
class C3k2_PFDConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_PFDConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_PFDConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_FasterFD(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FasterFD(self.c, self.c, 2, shortcut, g) if c3k else FasterFDConv(self.c, self.c) for _ in range(n)
        )
...
class C3k2_DSAN_EDFFN(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DSAN_EDFFN(self.c, self.c, 2, shortcut, g) if c3k else DSAN_EDFFN(self.c) for _ in range(n)
        )
...
class C3k2_MambaOut_DSA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MambaOut_DSA(self.c, self.c, n, shortcut, g) if c3k else GatedDSABlock_BCHW(self.c) for _ in range(n)
        )
...
class C3k2_DSA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_DSA(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_DSA(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_RMB(C3k2):
    def __init__(self, c1, c2, n=1, size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_RMB(self.c, self.c, 2, size, shortcut, g)
            if c3k
            else RMB(self.c, size, shift_size=(0 if _ % 2 == 0 else 2))
            for _ in range(n)
        )
...
class C3k2_SFSConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_SFSConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_SFSConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_MambaOut_SFSC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MambaOut_SFSC(self.c, self.c, n, shortcut, g) if c3k else GatedSFSCBlock_BCHW(self.c) for _ in range(n)
        )
...
class C3k2_PSFSConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_PSFSConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_PSFSConv(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_FasterSFSC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FasterSFSC(self.c, self.c, 2, shortcut, g) if c3k else FasterSFSConv(self.c, self.c) for _ in range(n)
        )
...
class C3k2_GroupMamba(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_GroupMamba(self.c, self.c, 2, shortcut, g) if c3k else GroupMambaLayer(self.c, self.c) for _ in range(n)
        )
...
class C3k2_GroupMambaBlock(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_GroupMambaBlock(self.c, self.c, 2, shortcut, g) if c3k else Block_mamba(self.c) for _ in range(n)
        )
...
class wConv2d(nn.Module):
    def __init__(
        self, in_channels, out_channels, kernel_size, den, stride=1, padding=1, groups=1, dilation=1, bias=False
    ):
        super().__init__()
...
class C3k2_wConv(C3k2):
    def __init__(self, c1, c2, n=1, den=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_wConv(self.c, self.c, 2, den, shortcut, g)
            if c3k
            else Bottleneck_wConv(self.c, self.c, shortcut, g, den=den)
            for _ in range(n)
        )
...
class C3k_FourierConv(C3k):
    def __init__(self, c1, c2, n=1, feat_size=None, shortcut=False, g=1, e=0.5, k=3):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(
            *(Bottleneck_FourierConv(c_, c_, shortcut, g, k=(k, k), size=feat_size, e=1.0) for _ in range(n))
        )
...
class C3k2_FourierConv(C3k2):
    def __init__(self, c1, c2, n=1, feat_size=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FourierConv(self.c, self.c, 2, feat_size, shortcut, g)
            if c3k
            else Bottleneck_FourierConv(self.c, self.c, shortcut, g, size=feat_size)
            for _ in range(n)
        )
...
class C3k2_GLVSS(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_GLVSS(self.c, self.c, 2, shortcut, g) if c3k else GL_VSS(self.c, self.c) for _ in range(n)
        )
...
class C3k2_ConvAttn(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_ConvAttn(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_ConvAttn(self.c, self.c, shortcut)
            for _ in range(n)
        )
...
class MBRConv3(nn.Module):
    ...
    def forward_(self, inp):
        ...
        x = torch.cat(
            [x0, x1, x2, x3, self.conv_bn(x0), self.conv1_bn(x1), self.conv_crossh_bn(x2), self.conv_crossv_bn(x3)], 1
        )
        out = self.conv_out(x)
        return out
...
class C3k2_MBRConv3(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MBRConv3(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_MBRConv3(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_MBRConv5(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_MBRConv5(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_MBRConv5(self.c, self.c, shortcut, g)
            for _ in range(n)
        )
...
class C3k2_VSSD(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_VSSD(self.c, self.c, 2, shortcut, g) if c3k else VMAMBA2Block(self.c) for _ in range(n)
        )
...
class C3k2_UniConvBlock(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_UniConvBlock(self.c, self.c, 2, shortcut, g) if c3k else UniConvBlock(self.c) for _ in range(n)
        )
...
class C3k2_ConverseB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_ConverseB(self.c, self.c, 2, shortcut, g) if c3k else ConverseBlock(self.c, self.c, 3) for _ in range(n)
        )
...
class C3k2_Converse(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_Converse(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_Converse(self.c, self.c, shortcut)
            for _ in range(n)
        )
...
class C3k2_GCConv(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_GCConv(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_GCConv(self.c, self.c, shortcut)
            for _ in range(n)
        )
...
class C3k2_CFBlock(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_CFBlock(self.c, self.c, 2, shortcut, g) if c3k else CFBlock(self.c, self.c) for _ in range(n)
        )
...
class C3k2_FMABlock(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_FMABlock(self.c, self.c, 2, shortcut, g) if c3k else FMABlock(self.c) for _ in range(n)
        )
...
class C3k2_LWGA(C3k2):
    def __init__(self, c1, c2, n=1, stage=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_LWGA(self.c, self.c, 2, stage, shortcut, g) if c3k else LWGA_Block(self.c, stage) for _ in range(n)
        )
...
class C3k2_EVA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        # kernel_size可选7,11,23,35
        self.m = nn.ModuleList(
            C3k_EVA(self.c, self.c, 2, shortcut, g) if c3k else EVA(self.c, kernel_size=7) for _ in range(n)
        )
...
class C3k2_RMBC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        # kernel_size可选7,11,23,35
        self.m = nn.ModuleList(
            C3k_RMBC(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_RepMBConv(self.c, self.c, shortcut=shortcut, g=g)
            for _ in range(n)
        )
...
class C3k2_RMBC_LA(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        # kernel_size可选7,11,23,35
        self.m = nn.ModuleList(
            C3k_RMBC_LA(self.c, self.c, 2, shortcut, g)
            if c3k
            else Bottleneck_RepMBConv_LA(self.c, self.c, shortcut=shortcut, g=g)
            for _ in range(n)
        )
...
class C3k2_IEL(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            C3k_IEL(self.c, self.c, 2, shortcut, g) if c3k else IEL(self.c, self.c) for _ in range(n)
        )
